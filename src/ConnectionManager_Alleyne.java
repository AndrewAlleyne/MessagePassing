...
public class ConnectionManager_Alleyne {
   ...
   static private PipedInputStream   threadA_threadB_PIS;
   static private PipedOutputStream  threadA_threadB_POS;
   ...
   public static void main ( String argv[] ) {
      try {
          ...
          ThreadA_Alleyne TA = new ThreadA_Alleyne(threadA_threadC_POS, threadA_threadC_PIS, ois, threadB_threadA_PIS);

          //ThreadC sends to ThreadD but receives from ThreadA
          ThreadC_Alleyne TC = new ThreadC_Alleyne(threadA_threadC_PIS, threadB_threadC_PIS, threadC_threadD_POS);
          ...
          ThreadD_Alleyne TD = new ThreadD_Alleyne(threadC_threadD_PIS);
